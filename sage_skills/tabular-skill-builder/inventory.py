#!/usr/bin/env python3
"""Canonical inventory script bundled with the tabular-skill-builder meta-skill.

Run this verbatim — do not rewrite it. It walks a local source directory
(a cloned repo, a CKAN download, or any staged folder), captures schema
metadata for every tabular file (CSV/TSV/XLSX/XLS/Parquet), groups
