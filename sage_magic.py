...
try:
    ...
    def ask(line, cell=None):
        ...
        system_prompt_text = (
            ...
            f"Inventing a value for a user-set variable will produce results for the WRONG location/"
            f"dataset/selection and is one of the worst possible failure modes — the user will "
            f"believe they got an answer for their input when they did not.\n"
