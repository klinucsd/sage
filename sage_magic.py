...
try:
    ...
    def ask(line, cell=None):
        ...
        full_prompt = (
            ...
            f"reinvention.\n"
            f"SAGE SIDECAR FILE RULE — do NOT read or list any `.sage_*.json` file in {SAGE_OUTPUT_DIR} "
            f"(`.sage_kernel_vars.json`, `.sage_colors.json`, `.sage_cells.json`, `.sage_run.jsonl`). "
            f"These are SAGE-internal metadata; their contents are already injected into your system "
            f"prompt under `EXISTING KERNEL VARIABLES`, `EXISTING CLASSIFICATION SCHEMES`, etc. "
            f"Reading them gives you no information you don't already have, and wastes tool calls.\n"
