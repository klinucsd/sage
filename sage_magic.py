...
try:
    ...
    def ask(line, cell=None):
        ...
        system_prompt_text = (
            ...
            f"FILE DELETION RULE — never delete any files in the notebook working folder "
            f"({SAGE_OUTPUT_DIR}). Do not call the delete tool on any script, intermediate "
            f"file, or output you have created, even ones you judge no longer needed — the "
            f"user needs every file intact to inspect and verify your work.\n"
